...
class ListsTable extends AbstractTableGateway {
    ...
    public function getResListeListsws($id, $type) {
     ...
     //   $select->columns(array('d.list_id', 'd.list_nom', 'd.list_tete', 'd.list_image', 'd.list_logo', 'd.list_imageGroup' => 'd.list_type', 'd.list_valide' => 'd.list_publie'));
        $select->from(array('l' => 'list'))
                ->join(array('d' => 'delegation'), 'd.id = l.list_idDelegation', 
                        array('nomDelegation' => 'nom',
                            'nomArabeDelegation' => 'nomArabe',
                            'nbrChaise' => 'nbrChaise',
                            'nbrListes' => 'nbrListes',
                            'tauxParticipation' => 'tauxParticipation',
                            'nbrVotesBlancs' => 'nbrVotesBlancs',
                            'nbrVotesAnnules' => 'nbrVotesAnnules',
      ...
      public function getAdminListeListsws($id,$type) {
    ...
    public function saveLists(Lists $list) {
        $data = array(
            ...
            'list_chaise' => $list->list_chaise,
            'list_vote' => $list->list_vote,
            'list_taux' => $list->list_taux,
