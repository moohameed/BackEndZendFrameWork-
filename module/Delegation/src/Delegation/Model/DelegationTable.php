...
class DelegationTable extends AbstractTableGateway {
    ...
    public function getListeDelegation() {
        ...
        $sql = new Sql($this->adapter);
        $select = $sql->select();
        $select->columns(array('id', 'nom', 'nomArabe', 'nbrChaise','nbrListes', 'tauxParticipation', 'nbrVotesBlancs', 'nbrVotesAnnules', 'nbrInscrits',
            'deate_creation', 'idGouvernorat', 'nomGouvernorat' => 'nom', 'nomArabeGouvernorat' => 'nomArabe'));
    ...
    public function saveDelegation(Delegation $delegation) {
        ...
        $data = array(
            ...
            'nbrListes' => $delegation->nbrListes,
            'tauxParticipation' => $delegation->tauxParticipation,
            'nbrVotesBlancs' => $delegation->nbrVotesBlancs,
            'nbrVotesAnnules' => $delegation->nbrVotesAnnules,
            'nbrInscrits' => $delegation->nbrInscrits,
